...
func Setup(r1cs *backend_bls381.R1CS, pk *ProvingKey, vk *VerifyingKey) {
	...
	*/
	...
	gateGroup := backend_bls381.NewDomain(nbConstraints)
...
func setupABC(r1cs *backend_bls381.R1CS, g *backend_bls381.Domain, tw toxicWaste) (A []fr.Element, B []fr.Element, C []fr.Element) {
