...
func referenceCircuit() (backend_bls381.R1CS, backend.Assignments, backend.Assignments) {
...
func (assert *Assert) Solved(r1cs *backend_bls381.R1CS, solution backend.Assignments, expectedValues map[string]interface{}) {
	// setup
