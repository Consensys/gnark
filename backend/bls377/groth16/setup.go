...
func Setup(r1cs *backend_bls377.R1CS, pk *ProvingKey, vk *VerifyingKey) {
	...
	*/
	...
	gateGroup := backend_bls377.NewDomain(root, backend_bls377.MaxOrder, nbConstraints)
...
func setupWitnessPolynomial(pk *ProvingKey, tw toxicWaste, g *backend_bls377.Domain) {
...
func setupABC(r1cs *backend_bls377.R1CS, g *backend_bls377.Domain, tw toxicWaste) (A []fr.Element, B []fr.Element, C []fr.Element) {
...
func setupKeyVectors(A, B, C []fr.Element, pk *ProvingKey, vk *VerifyingKey, tw toxicWaste, r1cs *backend_bls377.R1CS) {
