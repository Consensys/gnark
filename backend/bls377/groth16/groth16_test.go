...
func BenchmarkProver(b *testing.B) {
	...
	var pk groth16_bls377.ProvingKey
	groth16_bls377.DummySetup(r1cs.(*backend_bls377.R1CS), &pk)

	b.ResetTimer()
	b.Run("prover", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			_, _ = groth16_bls377.Prove(r1cs.(*backend_bls377.R1CS), &pk, solution)
		}
	})
}
...
func BenchmarkVerifier(b *testing.B) {
	...
	var vk groth16_bls377.VerifyingKey
	groth16_bls377.Setup(r1cs.(*backend_bls377.R1CS), &pk, &vk)
	proof, err := groth16_bls377.Prove(r1cs.(*backend_bls377.R1CS), &pk, solution)
	if err != nil {
		panic(err)
	}
