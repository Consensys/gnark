...
func (p *Phase1) WriteTo(writer io.Writer) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "serialize"), slog.String("object", "mpc_phase1"))
	}()
...
func (p *Phase1) ReadFrom(reader io.Reader) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "deserialize"), slog.String("object", "mpc_phase1"))
	}()
...
func (p *Phase2) WriteTo(writer io.Writer) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "serialize"), slog.String("object", "mpc_phase2"))
	}()
...
func (p *Phase2) ReadFrom(reader io.Reader) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "deserialize"), slog.String("object", "mpc_phase2"))
	}()
...
func (c *SrsCommons) WriteTo(writer io.Writer) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "serialize"), slog.String("object", "mpc_srs_commons"))
	}()
...
func (c *SrsCommons) ReadFrom(reader io.Reader) (n int64, err error) {
	start := time.Now()
	defer func() {
		logSerializationDebug(start, n, err, slog.String("backend", "groth16"), slog.String("operation", "deserialize"), slog.String("object", "mpc_srs_commons"))
	}()
