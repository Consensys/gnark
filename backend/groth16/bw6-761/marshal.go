...
func (vk *VerifyingKey) writeTo(w io.Writer, raw bool) (int64, error) {
	...
	if vk.PublicCommitted == nil {
		vk.PublicCommitted = [][]int{} // only matters in tests
	}
	if err := enc.Encode(utils.IntSliceSliceToUint64SliceSlice(vk.PublicCommitted)); err != nil {
		return enc.BytesWritten(), err
	}
...
func (vk *VerifyingKey) readFrom(r io.Reader, decOptions ...func(*curve.Decoder)) (int64, error) {
	...
	vk.PublicCommitted = utils.Uint64SliceSliceToIntSliceSlice(publicCommitted)
