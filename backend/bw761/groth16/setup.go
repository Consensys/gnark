...
func Setup(r1cs *backend_bw761.R1CS, pk *ProvingKey, vk *VerifyingKey) {
	...
	*/
	...
	domain := backend_bw761.NewDomain(nbConstraints)
...
func setupABC(r1cs *backend_bw761.R1CS, g *backend_bw761.Domain, toxicWaste toxicWaste) (A []fr.Element, B []fr.Element, C []fr.Element) {
