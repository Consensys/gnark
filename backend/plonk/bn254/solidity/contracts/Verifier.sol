...
contract PlonkVerifier {
  ...
  uint256 private constant g2_srs_1_x_0 = 9221380798419422064890293026770287937102595377376849696630513942878898404143;
  uint256 private constant g2_srs_1_x_1 = 578649790530361430064774161713570650834980274673917675840086854295241633516;
  uint256 private constant g2_srs_1_y_0 = 6354822383141612421889760753057835911933868753623449069380855870816083285517;
  uint256 private constant g2_srs_1_y_1 = 14041657921709154935945894710381235540033284330269221552629831165885115619101;
  ...
  uint256 private constant vk_ql_com_x = 13246321466322086203729709226224949402737955713999832738761007063967998738696;
  uint256 private constant vk_ql_com_y = 13142140590432028141021044116679355023172621208291759070990813968152949761623;
  uint256 private constant vk_qr_com_x = 20956953654751901267766059241984667034750732485521287677044979835705682355561;
  uint256 private constant vk_qr_com_y = 19875315052207145928922146841918193849547333887270576012047551753778833548903;
  uint256 private constant vk_qm_com_x = 11204263118416901815588153294657941706499947928817787526262740142349735535024;
  uint256 private constant vk_qm_com_y = 16299203454925518806743609232683225286583667891450806159087873637139798864186;
  uint256 private constant vk_qo_com_x = 20956953654751901267766059241984667034750732485521287677044979835705682355561;
  uint256 private constant vk_qo_com_y = 2012927819632129293324258903339081239148977270027247650641486140866392659680;
  uint256 private constant vk_qk_com_x = 11204263118416901815588153294657941706499947928817787526262740142349735535024;
  uint256 private constant vk_qk_com_y = 5589039416913756415502796512574049802112643265847017503601164257505427344397;
  
  uint256 private constant vk_s1_com_x = 21678546801769198984451643799954666305239740215300258262865345171762917193977;
  uint256 private constant vk_s1_com_y = 20835061190198575451123231016174580290090793057502694739242262695774956862647;
  
  uint256 private constant vk_s2_com_x = 7229946534837012419505560650911921735485483348017956818280254414887802683669;
  uint256 private constant vk_s2_com_y = 13107472263666581915254164168130343960962137684354357651675964959508929457544;
  
  uint256 private constant vk_s3_com_x = 14506895020525561454314969257438895492766371504821564386746129705818474285056;
  uint256 private constant vk_s3_com_y = 13942648942710168732947093604107848777371974330446912345030426285542353502692;
  
  uint256 private constant vk_coset_shift = 5;
  
  uint256 private constant vk_qc_0_x = 19560016514751534978209683361522020737885566551348428800154936285793480505208;
  uint256 private constant vk_qc_0_y = 9709530993015133419870705197472744014618455781465966295981995270314554628168;
  
  uint256 private constant vk_qc_1_x = 11264192824343911069187020799517651532737886815049902520610083166721638281972;
  uint256 private constant vk_qc_1_y = 14997596970724795102357364877375339459516038712987819648575872362661395800317;
  
  uint256 private constant vk_index_commit_api_0 = 3;
  uint256 private constant vk_index_commit_api_1 = 7;
  
  uint256 private constant vk_nb_custom_gates = 2;
  ...
  public view returns(bool success) {
    ...
    assembly {
      ...
      function derive_gamma(aproof, nb_pi, pi)->gamma_not_reduced {
        ...
        mstore(add(mPtr, 0x260), vk_qc_1_x)
        mstore(add(mPtr, 0x280), vk_qc_1_y)
      ...
      function compute_gamma_kzg(aproof) {
        ...
        mstore(add(mPtr,offset), vk_qc_1_x)
        mstore(add(mPtr,add(offset, 0x20)), vk_qc_1_y)
        offset := add(offset, 0x40)
