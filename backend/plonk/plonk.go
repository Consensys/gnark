...
func Setup(ccs frontend.CompiledConstraintSystem, polynomialCommitment interface{}) (ProvingKey, VerifyingKey, error) {
	...
	case *cs_bn254.SparseR1CS:
		return plonk_bn254.Setup(tccs, nil)
	case *cs_bls12381.SparseR1CS:
		return plonk_bls12381.Setup(tccs, nil)
	case *cs_bls12377.SparseR1CS:
		return plonk_bls12377.Setup(tccs, nil)
	case *cs_bw6761.SparseR1CS:
		return plonk_bw6761.Setup(tccs, nil)
	case *cs_bls24315.SparseR1CS:
		return plonk_bls24315.Setup(tccs, nil)
	default:
...
func Prove(sparseR1cs frontend.CompiledConstraintSystem, pk ProvingKey, fullWitness frontend.Circuit) (Proof, error) {
	...
	case *cs_bn254.SparseR1CS:
		...
		return plonk_bn254.Prove(_sparseR1cs, pk.(*plonk_bn254.ProvingKey), w)
	...
	case *cs_bls12381.SparseR1CS:
		...
		return plonk_bls12381.Prove(_sparseR1cs, pk.(*plonk_bls12381.ProvingKey), w)
	...
	case *cs_bls12377.SparseR1CS:
		...
		return plonk_bls12377.Prove(_sparseR1cs, pk.(*plonk_bls12377.ProvingKey), w)
	...
	case *cs_bw6761.SparseR1CS:
		...
		return plonk_bw6761.Prove(_sparseR1cs, pk.(*plonk_bw6761.ProvingKey), w)
	...
	case *cs_bls24315.SparseR1CS:
		...
		return plonk_bls24315.Prove(_sparseR1cs, pk.(*plonk_bls24315.ProvingKey), w)
