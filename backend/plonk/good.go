...
func Verify(proof *Proof, vk *VerifyingKey, publicWitness fr.Vector) error {
	...
	claimedQuotient := proof.BatchedProof.ClaimedValues[1]
	linearizedPolynomialZeta := proof.BatchedProof.ClaimedValues[2]
	l := proof.BatchedProof.ClaimedValues[3]
	r := proof.BatchedProof.ClaimedValues[4]
	o := proof.BatchedProof.ClaimedValues[5]
	s1 := proof.BatchedProof.ClaimedValues[6]
	s2 := proof.BatchedProof.ClaimedValues[7]
	qC := proof.BatchedProof.ClaimedValues[0]
	...
	fmt.Println("quotient =", claimedQuotient.Text(16))
