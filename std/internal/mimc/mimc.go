...
//
// This is an internal package as the implementation is used for some internal
// components and proof recursion where importing the
// [github.com/consensys/gnark/std/hash] package would create an import cycle.
package mimc
