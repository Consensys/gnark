...
func Verify(api frontend.API, commitment Digest, proof OpeningProof, point frontend.Variable, srs VK) {
	...
	// are elements in 𝔽_p, i.e. the BW6-633 scalar field.
	// This is different from 𝔽_r, i.e. the BLS24-315 scalar field
	// but r << p (p-r ≈ 315-bit) so when adding two 𝔽_r elements
