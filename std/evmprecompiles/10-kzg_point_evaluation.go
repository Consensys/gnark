...
//
// z, y are the point at which the proof is opened and the clamied value
// comCompressed is the commitment compressed on 48 bytes
// proofCompressed is the proof compressed on 48 bytes
//
