...
var blobPrecompileReturnValue = [64]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x73, 0xed, 0xa7, 0x53, 0x29, 0x9d, 0x7d, 0x48, 0x33, 0x39, 0xd8, 0x08, 0x09, 0xa1, 0xd8, 0x05, 0x53, 0xbd, 0xa4, 0x02, 0xff, 0xfe, 0x5b, 0xfe, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01}
...
func KzgPointEvaluation(
	api frontend.API,
	z, y *emulated.Element[emulated.BLS12381Fr],
	comCompressed, proofCompressed []uints.U8,
	...
	comSerialised := make([]uints.U8, nbBytes)
	copy(comSerialised, comCompressed)
	...
	proofSerialised := make([]uints.U8, nbBytes)
	copy(proofSerialised, proofCompressed)
	...
	var res [64]uints.U8
	for i := 0; i < 64; i++ {
		res[i] = uints.NewU8(blobPrecompileReturnValue[i])
	}
