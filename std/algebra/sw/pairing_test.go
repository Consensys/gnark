...
func (circuit *lineEvalBLS377) Define(curveID gurvy.ID, cs *frontend.CS) error {
	...
	cs.MustBeEqual(expected.r0.A1, "232134458700276476669584229661634543747068594368664068937164975724095736595288995356706959089579876199020312643174")
	cs.MustBeEqual(expected.r1.A0, "74241662856820718491669277383162555524896537826488558937227282983357670568906847284642533051528779250776935382660")
	cs.MustBeEqual(expected.r1.A1, "9787836945036920457066634104342154603142239983688979247440278426242314457905122599227144555989168817796094251258")
	cs.MustBeEqual(expected.r2.A0, "85129589817387660717039592198118788807152207633847410148299763250229022303850156734979397272700502238285752744807")
	cs.MustBeEqual(expected.r2.A1, "245761211327131018855579902758747359135620549826797077633679496719449586668701082009536667506317412690997533857875")
...
func mustbeEq(cs *frontend.CS, fp12 fields.E12, e12 *bls377.PairingResult, tagPrefix string) {
	...
	cs.MustBeEqual(fp12.C0.B0.A0, e12.C0.B0.A0)
	cs.MustBeEqual(fp12.C0.B0.A1, e12.C0.B0.A1)
	cs.MustBeEqual(fp12.C0.B1.A0, e12.C0.B1.A0)
	cs.MustBeEqual(fp12.C0.B1.A1, e12.C0.B1.A1)
	cs.MustBeEqual(fp12.C0.B2.A0, e12.C0.B2.A0)
	cs.MustBeEqual(fp12.C0.B2.A1, e12.C0.B2.A1)
	cs.MustBeEqual(fp12.C1.B0.A0, e12.C1.B0.A0)
	cs.MustBeEqual(fp12.C1.B0.A1, e12.C1.B0.A1)
	cs.MustBeEqual(fp12.C1.B1.A0, e12.C1.B1.A0)
	cs.MustBeEqual(fp12.C1.B1.A1, e12.C1.B1.A1)
	cs.MustBeEqual(fp12.C1.B2.A0, e12.C1.B2.A0)
	cs.MustBeEqual(fp12.C1.B2.A1, e12.C1.B2.A1)
}
