...
func (circuit *g2AddAssign) Define(curveID ecc.ID, gnark frontend.API) error {
	expected := circuit.A
	expected.AddAssign(gnark, &circuit.B, fields.GetBLS377ExtensionFp12(gnark))
...
func (circuit *g2AddAssignAffine) Define(curveID ecc.ID, gnark frontend.API) error {
	expected := circuit.A
	expected.AddAssign(gnark, &circuit.B, fields.GetBLS377ExtensionFp12(gnark))
	expected.MustBeEqual(gnark, circuit.C)
	return nil
...
func (circuit *g2DoubleAssign) Define(curveID ecc.ID, gnark frontend.API) error {
	expected := circuit.A
	expected.Double(gnark, &circuit.A, fields.GetBLS377ExtensionFp12(gnark))
	expected.MustBeEqual(gnark, circuit.C)
	return nil
}
...
func (circuit *g2DoubleAffine) Define(curveID ecc.ID, gnark frontend.API) error {
	expected := circuit.A
	expected.Double(gnark, &circuit.A, fields.GetBLS377ExtensionFp12(gnark))
	expected.MustBeEqual(gnark, circuit.C)
	return nil
...
func (circuit *g2Neg) Define(curveID ecc.ID, gnark frontend.API) error {
	expected := G2Jac{}
