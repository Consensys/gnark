...
type g2varScalarMulFakeGLV struct {
	A g2AffP
	C g2AffP `gnark:",public"`
	R frontend.Variable
}

func (circuit *g2varScalarMulFakeGLV) Define(api frontend.API) error {
	expected := g2AffP{}
...
func TestVarScalarMulG2FakeGLV(t *testing.T) {
	// sample random point
	_a := randomPointG2()
	var a, c bls12377.G2Affine
	a.FromJacobian(&_a)
	...
	// create the cs
	var circuit, witness g2varScalarMulFakeGLV
	var r fr.Element
	_, _ = r.SetRandom()
	witness.R = r.String()
	// assign the inputs
...
type g2varScalarMulFakeGLVEdgeCases struct {
	A g2AffP
	R frontend.Variable
}

func (circuit *g2varScalarMulFakeGLVEdgeCases) Define(api frontend.API) error {
	expected1 := g2AffP{}
	expected2 := g2AffP{}
	zero := fields_bls12377.E2{A0: 0, A1: 0}
	infinity := g2AffP{X: zero, Y: zero}
...
func TestVarScalarMulFakeGLVG2EdgeCases(t *testing.T) {
	// sample random point
	_a := randomPointG2()
	var a bls12377.G2Affine
	a.FromJacobian(&_a)
	...
	// create the cs
	var circuit, witness g2varScalarMulFakeGLVEdgeCases
	var r fr.Element
	_, _ = r.SetRandom()
	witness.R = r.String()
	// assign the inputs
