...
func (circuit *g1varScalarMulEdgeCases) Define(api frontend.API) error {
	expected1 := G1Affine{}
	expected2 := G1Affine{}
	expected2.varScalarMul(api, circuit.Inf, circuit.R)
	expected1.varScalarMul(api, circuit.A, circuit.Zero)
	expected1.AssertIsEqual(api, circuit.Inf)
	expected2.AssertIsEqual(api, circuit.Inf)
	return nil
}
...
func (circuit *g1JointScalarMulNaive) Define(api frontend.API) error {
	expected := G1Affine{}
	tmp := G1Affine{}
	tmp.varScalarMul(api, circuit.A, circuit.R, algopts.WithIncompleteArithmetic())
	expected.varScalarMul(api, circuit.B, circuit.S, algopts.WithIncompleteArithmetic())
...
func (circuit *scalarMulGLVAndFakeGLVEdgeCases) Define(api frontend.API) error {
	...
	expected1.varScalarMul(api, circuit.A, circuit.Zero)
	expected2.varScalarMul(api, circuit.Inf, circuit.R)
	expected3.varScalarMul(api, circuit.Inf, circuit.Zero)
	expected4.varScalarMul(api, circuit.A, circuit.One)
	expected1.AssertIsEqual(api, circuit.Inf)
	expected2.AssertIsEqual(api, circuit.Inf)
