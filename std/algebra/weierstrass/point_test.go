...
func TestNeg(t *testing.T) {
	...
	witness := NegTest[emulated.Secp256k1Fp, emulated.Secp256k1Fr]{
		P: AffinePoint[emulated.Secp256k1Fp]{
			X: emulated.FromConstant[emulated.Secp256k1Fp](secpCurve.Gx),
			Y: emulated.FromConstant[emulated.Secp256k1Fp](secpCurve.Gy),
		},
		Q: AffinePoint[emulated.Secp256k1Fp]{
			X: emulated.FromConstant[emulated.Secp256k1Fp](secpCurve.Gx),
			Y: emulated.FromConstant[emulated.Secp256k1Fp](yn),
		},
	}
...
func TestAdd(t *testing.T) {
	...
	witness := AddTest[emulated.Secp256k1Fp, emulated.Secp256k1Fr]{
		...
		Q: AffinePoint[emulated.Secp256k1Fp]{
			X: emulated.FromConstant[emulated.Secp256k1Fp](xd),
			Y: emulated.FromConstant[emulated.Secp256k1Fp](yd),
		},
		R: AffinePoint[emulated.Secp256k1Fp]{
			X: emulated.FromConstant[emulated.Secp256k1Fp](xa),
			Y: emulated.FromConstant[emulated.Secp256k1Fp](ya),
		},
	}
	err := test.IsSolved(&circuit, &witness, testCurve.ScalarField())
	assert.NoError(err)
...
func TestScalarMul(t *testing.T) {
	...
	witness := ScalarMulTest[emulated.Secp256k1Fp, emulated.Secp256k1Fr]{
		...
		Q: AffinePoint[emulated.Secp256k1Fp]{
			X: emulated.FromConstant[emulated.Secp256k1Fp](sx),
			Y: emulated.FromConstant[emulated.Secp256k1Fp](sy),
		},
	}
	err := test.IsSolved(&circuit, &witness, testCurve.ScalarField())
	assert.NoError(err)
...
func TestScalarMul2(t *testing.T) {
	...
	witness := ScalarMulTest[emulated.BN254Fp, emulated.BN254Fr]{
		S: emulated.FromConstant[emulated.BN254Fr](s),
		P: AffinePoint[emulated.BN254Fp]{
			X: emulated.FromConstant[emulated.BN254Fp](gen.X.BigInt(new(big.Int))),
			Y: emulated.FromConstant[emulated.BN254Fp](gen.Y.BigInt(new(big.Int))),
		},
		Q: AffinePoint[emulated.BN254Fp]{
			X: emulated.FromConstant[emulated.BN254Fp](res.X.BigInt(new(big.Int))),
			Y: emulated.FromConstant[emulated.BN254Fp](res.Y.BigInt(new(big.Int))),
		},
	}
	err := test.IsSolved(&circuit, &witness, testCurve.ScalarField())
	assert.NoError(err)
