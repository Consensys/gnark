...
func mustbeEq(api frontend.API, fp24 fields_bls24315.E24, e24 *bls24315.GT) {
	...
	api.AssertIsEqual(fp24.D2.C0.B0.A0, e24.D2.C0.B0.A0)
	api.AssertIsEqual(fp24.D2.C0.B0.A1, e24.D2.C0.B0.A1)
	api.AssertIsEqual(fp24.D2.C0.B1.A0, e24.D2.C0.B1.A0)
	api.AssertIsEqual(fp24.D2.C0.B1.A1, e24.D2.C0.B1.A1)
	api.AssertIsEqual(fp24.D2.C1.B0.A0, e24.D2.C1.B0.A0)
	api.AssertIsEqual(fp24.D2.C1.B0.A1, e24.D2.C1.B0.A1)
	api.AssertIsEqual(fp24.D2.C1.B1.A0, e24.D2.C1.B1.A0)
	api.AssertIsEqual(fp24.D2.C1.B1.A1, e24.D2.C1.B1.A1)
}
