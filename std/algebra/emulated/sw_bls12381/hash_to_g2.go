...
func (g2 *G2) MapToCurve2(u *fields_bls12381.E2) *G2Affine {
	// SSWU Steps:
	// 1.  tv1 = u^2
	tv1 := g2.Ext2.Square(u)
	// 2.  tv1 = Z * tv1
	tv1 = g2.Ext2.Mul(m.Z, tv1)
	// 3.  tv2 = tv1^2
	...
	tv4 := g2.Ext2.Select(s1, &m.Z, m.ext2.Neg(tv2))
	// 8.  tv4 = A * tv4
	tv4 = g2.Ext2.Mul(&m.A, tv4)
	// 9.  tv2 = tv3^2
	tv2 = g2.Ext2.Square(tv3)
	// 10. tv6 = tv4^2
	tv6 := g2.Ext2.Square(tv4)
	// 11. tv5 = A * tv6
	tv5 := g2.Ext2.Mul(&m.A, tv6)
	// 12. tv2 = tv2 + tv5
