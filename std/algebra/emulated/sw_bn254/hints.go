...
func millerLoopAndCheckFinalExpHint(nativeMod *big.Int, nativeInputs, nativeOutputs []*big.Int) error {
	...
	return emulated.UnwrapHint(nativeInputs, nativeOutputs,
		func(mod *big.Int, inputs, outputs []*big.Int) error {
			...
			residueWitnessInv.C0.B0.A0.BigInt(outputs[12])
			residueWitnessInv.C0.B0.A1.BigInt(outputs[13])
			residueWitnessInv.C0.B1.A0.BigInt(outputs[14])
			residueWitnessInv.C0.B1.A1.BigInt(outputs[15])
			residueWitnessInv.C0.B2.A0.BigInt(outputs[16])
			residueWitnessInv.C0.B2.A1.BigInt(outputs[17])
			residueWitnessInv.C1.B0.A0.BigInt(outputs[18])
			residueWitnessInv.C1.B0.A1.BigInt(outputs[19])
			residueWitnessInv.C1.B1.A0.BigInt(outputs[20])
			residueWitnessInv.C1.B1.A1.BigInt(outputs[21])
			residueWitnessInv.C1.B2.A0.BigInt(outputs[22])
			residueWitnessInv.C1.B2.A1.BigInt(outputs[23])

			// we also need to return the cubic non-residue power
			cubicNonResiduePower.C0.B0.A0.BigInt(outputs[24])
			cubicNonResiduePower.C0.B0.A1.BigInt(outputs[25])
			cubicNonResiduePower.C0.B1.A0.BigInt(outputs[26])
			cubicNonResiduePower.C0.B1.A1.BigInt(outputs[27])
			cubicNonResiduePower.C0.B2.A0.BigInt(outputs[28])
			cubicNonResiduePower.C0.B2.A1.BigInt(outputs[29])
			cubicNonResiduePower.C1.B0.A0.BigInt(outputs[30])
			cubicNonResiduePower.C1.B0.A1.BigInt(outputs[31])
			cubicNonResiduePower.C1.B1.A0.BigInt(outputs[32])
			cubicNonResiduePower.C1.B1.A1.BigInt(outputs[33])
			cubicNonResiduePower.C1.B2.A0.BigInt(outputs[34])
			cubicNonResiduePower.C1.B2.A1.BigInt(outputs[35])
