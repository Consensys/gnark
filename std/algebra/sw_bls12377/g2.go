...
func (p *G2Jac) AddAssign(api frontend.API, p1 *G2Jac, ext *fp2.Extension) *G2Jac {
	...
	var Z1Z1, Z2Z2, U1, U2, S1, S2, H, I, J, r, V fp2.E2
...
func (p *G2Jac) Double(api frontend.API, p1 *G2Jac, ext *fp2.Extension) *G2Jac {
	...
	var XX, YY, YYYY, ZZ, S, M, T fp2.E2
...
func (p *G2Jac) Assign(p1 *bls12377.G2Jac) {
	p.X.Assign([2]interface{}{p1.X.A0, p1.X.A1})
	p.Y.Assign([2]interface{}{p1.Y.A0, p1.Y.A1})
	p.Z.Assign([2]interface{}{p1.Z.A0, p1.Z.A1})
}
