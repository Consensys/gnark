...
type fp24MulBy012 struct {
	A    E24 `gnark:",public"`
	W    E24
	B, C E4
}

func (circuit *fp24MulBy012) Define(api frontend.API) error {
	ext := GetBLS24315ExtensionFp24(api)
	circuit.A.MulBy012(api, circuit.B, circuit.C, ext)
	circuit.A.MustBeEqual(api, circuit.W)
	return nil
}

func TestFp24MulBy012(t *testing.T) {

	var circuit, witness fp24MulBy012
...
type fp24FixedExpo struct {
	A E24
	C E24 `gnark:",public"`
}

func (circuit *fp24FixedExpo) Define(api frontend.API) error {
	expected := E24{}
	ext := GetBLS24315ExtensionFp24(api)
...
func TestExpFixedExpoFp24(t *testing.T) {
	var circuit, witness fp24FixedExpo
