...
func TestOneWireConstraint(t *testing.T) {
	...
	assert.Equal(OneWire, val.outputWire.Name, "constraint map should contain ONE_WIRE")
...
func TestSUB(t *testing.T) {
	...
	expectedValues["x-4"] = 42 - 4
	fourMinus42 := elementFromInterface(42)
...
func TestDIV(t *testing.T) {
	...
	// good solution
	good.Assign(Public, "x", 42)
	good.Assign(Public, "y", 142)

	// expected values
	xVal := elementFromInterface(42)
	xDiv := elementFromInterface(142)
	xDiv.Div(&xVal, &xDiv)
...
func TestDIVLC(t *testing.T) {
	...
	// good solution
	good.Assign(Public, "x", 8000)
	good.Assign(Public, "y", 80)
...
func TestSELECT(t *testing.T) {
	...
	bad.Assign(Public, "x", 10)
	bad.Assign(Public, "y", 42)
	bad.Assign(Public, "z", 8000)

	// good solution
	good.Assign(Public, "x", 0)
	good.Assign(Public, "y", 42)
	good.Assign(Public, "z", 8000)
...
func TestFROM_BINARY(t *testing.T) {
	...
	bad.Assign(Public, "b0", 3)
	bad.Assign(Public, "b1", 0)
	bad.Assign(Public, "b2", 1)
	bad.Assign(Public, "b3", 1)
	bad.Assign(Public, "b4", 0)

	// good solution
	good.Assign(Public, "b0", 1)
	good.Assign(Public, "b1", 0)
	good.Assign(Public, "b2", 1)
	good.Assign(Public, "b3", 0)
	good.Assign(Public, "b4", 1)
...
func TestTO_BINARY(t *testing.T) {
	...
	// bad solution
	// bad.Assign(Public, "x", 64) // TODO doesn't fit on 5 bits

	// good solution
	good.Assign(Public, "x", 17)
...
func TestSELECT_LUT(t *testing.T) {
	...
	var lut [4]curve.Element
	lut[0] = elementFromInterface(42)
	lut[2] = elementFromInterface(8000)
	...
	bad.Assign(Secret, "b0", 22)
	bad.Assign(Secret, "b1", 22)

	// good solution
	good.Assign(Secret, "b0", 1)
	good.Assign(Secret, "b1", 0)
...
func TestXOR(t *testing.T) {
	...
	// bad solution (non boolean inputs)
	bad.Assign(Public, "x", 22)
	bad.Assign(Public, "y", 22)
	bad.Assign(Public, "z", 22)

	// good solution
	good.Assign(Public, "x", 1)
	good.Assign(Public, "y", 0)
	good.Assign(Public, "z", 0)
...
func TestXtimes2EqualsY(t *testing.T) {
	...
	// bad solution
	bad.Assign(Public, "x", 42)
	bad.Assign(Secret, "y", 42*42)

	// good solution
	good.Assign(Public, "x", 42)
	good.Assign(Secret, "y", 42*2)
...
func TestMerge(t *testing.T) {
	...
	// bad solution
	bad.Assign(Secret, "u", 42)
	bad.Assign(Secret, "v", 8000)
	bad.Assign(Public, "w", 42)

	// good solution
	uVal := elementFromInterface(2)
	var uInvVal curve.Element
	uInvVal.Inverse(&uVal)
	wWal := elementFromInterface(65536)
	wWal.Mul(&wWal, &uInvVal)

	good.Assign(Secret, "u", 2)
	good.Assign(Secret, "v", 65536)
	good.Assign(Public, "w", wWal)
...
func TestMergeMoeNoe(t *testing.T) {
	...
	// bad solution
	bad.Assign(Secret, "u", 0)
	bad.Assign(Public, "w", 5)

	// good solution
	good.Assign(Secret, "u", 1)
	good.Assign(Public, "w", 5)
