...
func New() CS {
	...
	oneConstraint.outputWire.Value.SetOne()
...
func (cs *CS) mulConstant(c *Constraint, constant curve.Element) *Constraint {
	expression := &term{
		Wire:      c.outputWire,
		Coeff:     constant,
		Operation: mul,
...
func (cs *CS) div(c1, c2 *Constraint) *Constraint {
	...
	expression := quadraticExpression{
		left:      linearExpression{term{Wire: c2.outputWire, Coeff: curve.One()}},
		right:     linearExpression{term{Wire: c1.outputWire, Coeff: curve.One()}},
		operation: div,
	}
...
// inv (e*c1)**-1
func (cs *CS) inv(c1 *Constraint, e curve.Element) *Constraint {
	expression := &term{
		Wire:      c1.outputWire,
		Coeff:     e,
		Operation: div,
...
func (cs *CS) add(c1 *Constraint, c2 *Constraint) *Constraint {
	...
	expression := &linearExpression{
		term{Wire: c1.outputWire, Coeff: curve.One()},
		term{Wire: c2.outputWire, Coeff: curve.One()},
	}
...
func (cs *CS) addConstant(c *Constraint, constant curve.Element) *Constraint {

	expression := &linearExpression{
		term{Wire: c.outputWire, Coeff: curve.One()},
...
func (cs *CS) subConstant(c *Constraint, constant curve.Element) *Constraint {
...
func (cs *CS) subConstraint(constant curve.Element, c *Constraint) *Constraint {
...
func (cs *CS) equalConstant(c *Constraint, constant curve.Element) error {
