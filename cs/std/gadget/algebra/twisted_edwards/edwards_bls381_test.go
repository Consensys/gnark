...
func TestAdd(t *testing.T) {
	...
	inputs.Assign(cs.Secret, "x", "21793328330329971148710654283888115697962123987759099803244199498744022094670")
	inputs.Assign(cs.Secret, "y", "2101040637884652362150023747029283466236613497763786920682459476507158507058")
...
func TestAddGeneric(t *testing.T) {
	...
	inputs := cs.NewAssignment()
	inputs.Assign(cs.Secret, "x1", "21793328330329971148710654283888115697962123987759099803244199498744022094670")
	inputs.Assign(cs.Secret, "y1", "2101040637884652362150023747029283466236613497763786920682459476507158507058")
	inputs.Assign(cs.Secret, "x2", "50629843885093813360334764484465489653158679010834922765195739220081842003850")
	inputs.Assign(cs.Secret, "y2", "39525475875082628301311747912064089490877815436253076910246067124459956047086")
...
func TestDouble(t *testing.T) {
	...
	inputs := cs.NewAssignment()
	inputs.Assign(cs.Secret, "x", "23426137002068529236790192115758361610982344002369094106619281483467893291614")
	inputs.Assign(cs.Secret, "y", "39325435222430376843701388596190331198052476467368316772266670064146548432123")
...
func TestScalarMulFixedBase(t *testing.T) {
	...
	inputs := cs.NewAssignment()
	inputs.Assign(cs.Secret, "scalar", "28242048")
