...
func (s *Scheme) BatchOpenSinglePoint(_val, challenge interface{}, _p ...polynomial.Polynomial) polynomial.BatchOpeningProofSinglePoint { //Open(p *bls377.Poly, val *fr.Element) *MockProof {
	return &MockProof{}
}
