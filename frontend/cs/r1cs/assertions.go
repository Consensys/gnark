...
func (system *R1CSRefactor) AssertIsEqual(i1, i2 interface{}) {
	// encoded 1 * i1 == i2
...
func (system *R1CSRefactor) AssertIsDifferent(i1, i2 interface{}) {
	system.Inverse(system.Sub(i1, i2))
}

// AssertIsBoolean adds an assertion in the constraint system (v == 0 || v == 1)
func (system *R1CSRefactor) AssertIsBoolean(i1 interface{}) {
...
func (system *R1CSRefactor) AssertIsLessOrEqual(_v cs.Variable, bound interface{}) {
...
func (system *R1CSRefactor) mustBeLessOrEqVar(a, bound compiled.Variable) {
...
func (system *R1CSRefactor) mustBeLessOrEqCst(a compiled.Variable, bound big.Int) {
