...
func (system *compiler) addPlonkConstraint(l, r, o compiled.Term, cidl, cidr, cidm1, cidm2, cido, k int, debugID ...int) {
...
func (system *compiler) newInternalVariable() compiled.Term {
...
func (system *compiler) zero() compiled.Term {
	var a compiled.Term
	return a
}
