...
func (cs *R1CSRefactor) AssertIsEqual(i1, i2 interface{}) {
	// encoded 1 * i1 == i2
...
func (cs *R1CSRefactor) AssertIsDifferent(i1, i2 interface{}) {
	cs.Inverse(cs.Sub(i1, i2))
}

// AssertIsBoolean adds an assertion in the constraint system (v == 0 || v == 1)
func (cs *R1CSRefactor) AssertIsBoolean(i1 interface{}) {
...
func (cs *R1CSRefactor) AssertIsLessOrEqual(_v frontend.Variable, bound interface{}) {
	...
	default:
		cs.mustBeLessOrEqCst(v[0], frontend.FromInterface(b))
	}

}

func (cs *R1CSRefactor) mustBeLessOrEqVar(a, bound compiled.Variable) {
...
func (cs *R1CSRefactor) mustBeLessOrEqCst(a compiled.Variable, bound big.Int) {
