...
type CreateProveJobResponse_Status int32

const (
	CreateProveJobResponse_OK  CreateProveJobResponse_Status = 0
	CreateProveJobResponse_NOK CreateProveJobResponse_Status = 1
)

// Enum value maps for CreateProveJobResponse_Status.
var (
	CreateProveJobResponse_Status_name = map[int32]string{
		0: "OK",
		1: "NOK",
	}
	CreateProveJobResponse_Status_value = map[string]int32{
		"OK":  0,
		"NOK": 1,
	}
)

func (x CreateProveJobResponse_Status) Enum() *CreateProveJobResponse_Status {
	p := new(CreateProveJobResponse_Status)
	*p = x
	return p
}

func (x CreateProveJobResponse_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CreateProveJobResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_pb_gnarkd_proto_enumTypes[0].Descriptor()
}

func (CreateProveJobResponse_Status) Type() protoreflect.EnumType {
	return &file_pb_gnarkd_proto_enumTypes[0]
}

func (x CreateProveJobResponse_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CreateProveJobResponse_Status.Descriptor instead.
func (CreateProveJobResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_pb_gnarkd_proto_rawDescGZIP(), []int{3, 0}
}

type ProveJobResult_Status int32

const (
	ProveJobResult_QUEUED          ProveJobResult_Status = 0
	ProveJobResult_RUNNING         ProveJobResult_Status = 1
	ProveJobResult_COMPLETED       ProveJobResult_Status = 2
	ProveJobResult_ERRORED         ProveJobResult_Status = 3
	ProveJobResult_WAITING_WITNESS ProveJobResult_Status = 4
)
...
func (ProveJobResult_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_pb_gnarkd_proto_enumTypes[1].Descriptor()
}

func (ProveJobResult_Status) Type() protoreflect.EnumType {
	return &file_pb_gnarkd_proto_enumTypes[1]
}
...
type CreateProveJobResponse struct {
	...
	Status CreateProveJobResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=gnarkd.CreateProveJobResponse_Status" json:"status,omitempty"`
	JobID  *string                       `protobuf:"bytes,2,opt,name=jobID,proto3,oneof" json:"jobID,omitempty"`
...
func (x *CreateProveJobResponse) GetStatus() CreateProveJobResponse_Status {
	if x != nil {
		return x.Status
	}
	return CreateProveJobResponse_OK
}
...
func (x *CreateProveJobResponse) GetErr() string {
	if x != nil && x.Err != nil {
		return *x.Err
	}
	return ""
...
type ProveJobStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ProveJobStatusRequest) Reset() {
	*x = ProveJobStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProveJobStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProveJobStatusRequest) ProtoMessage() {}

func (x *ProveJobStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_gnarkd_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProveJobStatusRequest.ProtoReflect.Descriptor instead.
func (*ProveJobStatusRequest) Descriptor() ([]byte, []int) {
	return file_pb_gnarkd_proto_rawDescGZIP(), []int{5}
}

func (x *ProveJobStatusRequest) GetJobID() string {
	if x != nil {
		return x.JobID
	}
	return ""
...
var file_pb_gnarkd_proto_rawDesc = []byte{
	...
	,
	...
	0x1d, 0x2e, 0x67, 0x6e, 0x61, 0x72, 0x6b, 0x64, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x65, 0x4a, 0x6f,
	0x62, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x15, 0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x03, 0x65, 0x72, 0x72, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a,
	0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x01, 0x52, 0x05,
	0x70, 0x72, 0x6f, 0x6f, 0x66, 0x88, 0x01, 0x01, 0x22, 0x52, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74,
	...
	0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x52,
	0x52, 0x4f, 0x52, 0x45, 0x44, 0x10, 0x03, 0x12, 0x13, 0x0a, 0x0f, 0x57, 0x41, 0x49, 0x54, 0x49,
	0x4e, 0x47, 0x5f, 0x57, 0x49, 0x54, 0x4e, 0x45, 0x53, 0x53, 0x10, 0x04, 0x42, 0x06, 0x0a, 0x04,
	0x5f, 0x65, 0x72, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x2d,
	0x0a, 0x15, 0x50, 0x72, 0x6f, 0x76, 0x65, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44, 0x32, 0xdb, 0x01,
	...
	,
...
var file_pb_gnarkd_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pb_gnarkd_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_pb_gnarkd_proto_goTypes = []interface{}{
	(CreateProveJobResponse_Status)(0), // 0: gnarkd.CreateProveJobResponse.Status
	(ProveJobResult_Status)(0),         // 1: gnarkd.ProveJobResult.Status
	(*ProveRequest)(nil),               // 2: gnarkd.ProveRequest
	(*ProveResult)(nil),                // 3: gnarkd.ProveResult
	(*CreateProveJobRequest)(nil),      // 4: gnarkd.CreateProveJobRequest
	(*CreateProveJobResponse)(nil),     // 5: gnarkd.CreateProveJobResponse
	(*ProveJobResult)(nil),             // 6: gnarkd.ProveJobResult
	(*ProveJobStatusRequest)(nil),      // 7: gnarkd.ProveJobStatusRequest
}
var file_pb_gnarkd_proto_depIdxs = []int32{
	0, // 0: gnarkd.CreateProveJobResponse.status:type_name -> gnarkd.CreateProveJobResponse.Status
	1, // 1: gnarkd.ProveJobResult.status:type_name -> gnarkd.ProveJobResult.Status
	2, // 2: gnarkd.Groth16.Prove:input_type -> gnarkd.ProveRequest
	4, // 3: gnarkd.Groth16.CreateProveJob:input_type -> gnarkd.CreateProveJobRequest
	7, // 4: gnarkd.Groth16.ProveJobStatus:input_type -> gnarkd.ProveJobStatusRequest
	3, // 5: gnarkd.Groth16.Prove:output_type -> gnarkd.ProveResult
	5, // 6: gnarkd.Groth16.CreateProveJob:output_type -> gnarkd.CreateProveJobResponse
	6, // 7: gnarkd.Groth16.ProveJobStatus:output_type -> gnarkd.ProveJobResult
...
func file_pb_gnarkd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_gnarkd_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProveJobStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pb_gnarkd_proto_msgTypes[3].OneofWrappers = []interface{}{}
