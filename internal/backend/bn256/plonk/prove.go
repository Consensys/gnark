...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bn256.Poly) (bn256.Poly, bn256.Poly, bn256.Poly) {

	h := make(bn256.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bn256.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bn256.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bn256.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bn256witness.Witness) *ProofRaw {
