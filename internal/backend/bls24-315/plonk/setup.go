...
type PublicRaw struct {
	...
	Ql, Qr, Qm, Qo, Qk bls24315.Polynomial
	...
	LS1, LS2, LS3 bls24315.Polynomial
	CS1, CS2, CS3 bls24315.Polynomial
...
func SetupRaw(spr *cs.SparseR1CS, polynomialCommitment polynomial.CommitmentScheme, publicWitness bls24_315witness.Witness) *PublicRaw {
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bls24315.Polynomial, nbElmt)
	publicData.LS2 = make(bls24315.Polynomial, nbElmt)
	publicData.LS3 = make(bls24315.Polynomial, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bls24315.Polynomial, nbElmt)
	publicData.CS2 = make(bls24315.Polynomial, nbElmt)
	publicData.CS3 = make(bls24315.Polynomial, nbElmt)
