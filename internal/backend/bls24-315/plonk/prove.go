...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bls24315.Polynomial, bls24315.Polynomial, bls24315.Polynomial, bls24315.Polynomial) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bls24315.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZ(l, r, o bls24315.Polynomial, publicData *PublicRaw, gamma fr.Element) bls24315.Polynomial {

	z := make(bls24315.Polynomial, publicData.DomainNum.Cardinality)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bls24315.Polynomial) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bls24315.Polynomial, gamma fr.Element) bls24315.Polynomial {
	...
	res := make(bls24315.Polynomial, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bls24315.Polynomial) bls24315.Polynomial {
...
func shiftZ(z bls24315.Polynomial) bls24315.Polynomial {

	res := make(bls24315.Polynomial, len(z))
	copy(res, z)
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls24315.Polynomial, alpha fr.Element) (bls24315.Polynomial, bls24315.Polynomial, bls24315.Polynomial) {

	h := make(bls24315.Polynomial, publicData.DomainH.Cardinality)
	...
	h1 := make(bls24315.Polynomial, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bls24_315witness.Witness) *ProofRaw {
	...
	cl := make(bls24315.Polynomial, len(ll))
	cr := make(bls24315.Polynomial, len(lr))
	co := make(bls24315.Polynomial, len(lo))
	copy(cl, ll)
	copy(cr, lr)
	copy(co, lo)
