...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bn254.Poly, bn254.Poly, bn254.Poly, bn254.Poly) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bn254.Poly
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZ(l, r, o bn254.Poly, publicData *PublicRaw) bn254.Poly {

	z := make(bn254.Poly, publicData.DomainNum.Cardinality)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bn254.Poly) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bn254.Poly) bn254.Poly {
	...
	res := make(bn254.Poly, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bn254.Poly) bn254.Poly {
...
func shiftZ(z bn254.Poly) bn254.Poly {

	res := make(bn254.Poly, len(z))
	copy(res, z)
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bn254.Poly) (bn254.Poly, bn254.Poly, bn254.Poly) {

	h := make(bn254.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bn254.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bn254.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bn254.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bn254witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bn254.Poly{l, r, o, z, h1, h2, h3}
