...
func ComputeLROBis(spr *cs.SparseR1CS, pk *ProvingKey, solution []fr.Element) (bn254.Polynomial, bn254.Polynomial, bn254.Polynomial) {

	s := int(pk.DomainNum.Cardinality)

	var l, r, o bn254.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZBis(l, r, o bn254.Polynomial, pk *ProvingKey, gamma fr.Element) bn254.Polynomial {

	z := make(bn254.Polynomial, pk.DomainNum.Cardinality)
...
func evalIDCosetsBis(pk *ProvingKey) (id, uid, uuid bn254.Polynomial) {
...
func evalConstraintOrderingBis(pk *ProvingKey, evalZ, evalZu, evalL, evalR, evalO bn254.Polynomial, gamma fr.Element) bn254.Polynomial {
	...
	res := make(bn254.Polynomial, 4*pk.DomainNum.Cardinality)
...
func evalStartsAtOneBis(pk *ProvingKey, evalZ bn254.Polynomial) bn254.Polynomial {
...
func shitZBis(z bn254.Polynomial) bn254.Polynomial {
...
func computeHBis(pk *ProvingKey, constraintsInd, constraintOrdering, startsAtOne bn254.Polynomial, alpha fr.Element) (bn254.Polynomial, bn254.Polynomial, bn254.Polynomial) {

	h := make(bn254.Polynomial, pk.DomainH.Cardinality)
	...
	h1 := make(bn254.Polynomial, pk.DomainNum.Cardinality)
	h2 := make(bn254.Polynomial, pk.DomainNum.Cardinality)
	h3 := make(bn254.Polynomial, pk.DomainNum.Cardinality)
...
func Prove(spr *cs.SparseR1CS, pk *ProvingKey, fullWitness bn254witness.Witness) (*ProofBis, error) {
	...
	cl := make(bn254.Polynomial, sizeCommon)
	cr := make(bn254.Polynomial, sizeCommon)
	co := make(bn254.Polynomial, sizeCommon)
	copy(cl, ll)
	copy(cr, lr)
	copy(co, lo)
	...
	qkFullC := make(bn254.Polynomial, sizeCommon)
