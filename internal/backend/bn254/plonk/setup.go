...
func commitTrace(trace *PlonkTrace, pk *ProvingKey) error {
...
func buildPermutation(spr *cs.SparseR1CS, pt *PlonkTrace, nbVariables int) {
...
func computePermutationPolynomials(pt *PlonkTrace, domain *fft.Domain) [3]*iop.Polynomial {
