...
import (
	...
	"github.com/consensys/gnark/crypto/polynomial/bls12-381"
...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bls12381.Poly, bls12381.Poly, bls12381.Poly, bls12381.Poly) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bls12381.Poly
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZ(l, r, o bls12381.Poly, publicData *PublicRaw) bls12381.Poly {

	z := make(bls12381.Poly, publicData.DomainNum.Cardinality)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bls12381.Poly) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bls12381.Poly) bls12381.Poly {
	...
	res := make(bls12381.Poly, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bls12381.Poly) bls12381.Poly {
...
func shiftZ(z bls12381.Poly) bls12381.Poly {

	res := make(bls12381.Poly, len(z))
	copy(res, z)
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls12381.Poly) (bls12381.Poly, bls12381.Poly, bls12381.Poly) {

	h := make(bls12381.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bls12381.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bls12381.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bls12381.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bls12_381witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bls12381.Poly{l, r, o, z, h1, h2, h3}
