...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bls12381.Polynomial, bls12381.Polynomial, bls12381.Polynomial, bls12381.Polynomial) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bls12381.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bls12381.Polynomial) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bls12381.Polynomial, gamma fr.Element) bls12381.Polynomial {
	...
	res := make(bls12381.Polynomial, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bls12381.Polynomial) bls12381.Polynomial {
...
func shiftZ(z bls12381.Polynomial) bls12381.Polynomial {
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls12381.Polynomial, alpha fr.Element) (bls12381.Polynomial, bls12381.Polynomial, bls12381.Polynomial) {
	...
	h1 := make(bls12381.Polynomial, publicData.DomainNum.Cardinality)
	h2 := make(bls12381.Polynomial, publicData.DomainNum.Cardinality)
	h3 := make(bls12381.Polynomial, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bls12_381witness.Witness) (*ProofRaw, error) {
