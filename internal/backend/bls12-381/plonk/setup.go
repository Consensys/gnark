...
type PublicRaw struct {
	...
	LS1, LS2, LS3 bls12381.Polynomial
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bls12381.Polynomial, nbElmt)
	publicData.LS2 = make(bls12381.Polynomial, nbElmt)
	publicData.LS3 = make(bls12381.Polynomial, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bls12381.Polynomial, nbElmt)
	publicData.CS2 = make(bls12381.Polynomial, nbElmt)
	publicData.CS3 = make(bls12381.Polynomial, nbElmt)
