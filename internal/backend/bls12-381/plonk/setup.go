...
type PublicRaw struct {
	...
	LS1, LS2, LS3 bls12381.Poly
	CS1, CS2, CS3 bls12381.Poly
...
func SetupRaw(spr *cs.SparseR1CS, polynomialCommitment polynomial.CommitmentScheme, publicWitness bls12_381witness.Witness) *PublicRaw {
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bls12381.Poly, nbElmt)
	publicData.LS2 = make(bls12381.Poly, nbElmt)
	publicData.LS3 = make(bls12381.Poly, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bls12381.Poly, nbElmt)
	publicData.CS2 = make(bls12381.Poly, nbElmt)
	publicData.CS3 = make(bls12381.Poly, nbElmt)
