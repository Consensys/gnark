...
import (
	...
	"github.com/consensys/gurvy/ecc/bls12-377/fr/fft"
)
...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bls377.Poly, bls377.Poly, bls377.Poly, bls377.Poly) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bls377.Poly
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZ(l, r, o bls377.Poly, publicData *PublicRaw) bls377.Poly {

	z := make(bls377.Poly, publicData.DomainNum.Cardinality)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bls377.Poly) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bls377.Poly) bls377.Poly {
	...
	res := make(bls377.Poly, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bls377.Poly) bls377.Poly {
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls377.Poly) (bls377.Poly, bls377.Poly, bls377.Poly) {

	h := make(bls377.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bls377.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bls377.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bls377.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bls377witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bls377.Poly{l, r, o, z, h1, h2, h3}
