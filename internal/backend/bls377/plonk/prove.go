...
func ComputePermutations(publicData *PublicRaw) (bls377.Poly, bls377.Poly, bls377.Poly) {
	...
	s1 := make(bls377.Poly, nbElmt)
	s2 := make(bls377.Poly, nbElmt)
	s3 := make(bls377.Poly, nbElmt)
	for i := 0; i < nbElmt; i++ {
...
func ComputeZ(l, r, o, s1, s2, s3 bls377.Poly, publicData *PublicRaw) bls377.Poly {
