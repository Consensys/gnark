...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls377.Poly) bls377.Poly {

	h := make(bls377.Poly, 4*publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, witness bls377witness.Witness) *ProofRaw {
