...
func prove(r1cs *bls377backend.R1CS, pk *ProvingKey, solution map[string]interface{}, unsafe bool) (*Proof, error) {
...
// statisfied.
func ProveUnsafe(r1cs *bls377backend.R1CS, pk *ProvingKey, solution map[string]interface{}) *Proof {
