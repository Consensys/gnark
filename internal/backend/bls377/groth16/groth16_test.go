...
func BenchmarkSerialization(b *testing.B) {
	...
	})
	{
		var buf bytes.Buffer
		n, _ := pk.WriteTo(&buf)
		fmt.Println("sizeOf(bls377groth16.ProvingKey) binary", n)
		fmt.Println("")
	}
	...
	})
	{
		...
		fmt.Println("sizeOf(bls377groth16.ProvingKey) binary raw", n)
		fmt.Println("")
	}
	...
	})
	{
		...
		enc := cbor.NewEncoder(&buf)
		enc.Encode(&pk)
		fmt.Println("sizeOf(bls377groth16.ProvingKey) binary cbor", buf.Len())
		fmt.Println("")
	}
	...
	})
	{
		...
		fmt.Println("sizeOf(bls377groth16.Proof) binary", n)
		fmt.Println("")
	}
	...
	})
	{
		...
		fmt.Println("sizeOf(bls377groth16.Proof) binary raw", n)
		fmt.Println("")
	}
	...
	})
	{
		...
		enc := cbor.NewEncoder(&buf)
		enc.Encode(&proof)
		fmt.Println("sizeOf(bls377groth16.Proof) binary cbor", buf.Len())
		fmt.Println("")
	}
