...
func (plonkcs *CS) GetNbPublicWires() uint64 {
	return uint64(plonkcs.NbPublicVariables)
}

func (plonkcs *CS) GetNbSecretWires() uint64 {
	return uint64(plonkcs.NbSecretVariables)
}

func (plonkcs *CS) SizeFrElement() int {
	return fr.Limbs * 8
}

func (plonkcs *CS) WriteTo(w io.Writer) (int64, error) {
	panic("not implemented")
}

// ReadFrom attempts to decode R1CS from io.Reader using cbor
func (plonkcs *CS) ReadFrom(r io.Reader) (int64, error) {
	panic("not implemented")
}
...
// GetCurveID returns curve ID as defined in gurvy (gurvy.BLS377)
...
func (plonkcs *CS) solveConstraint(c backend.SparseR1C, wireInstantiated []bool, solution []fr.Element) {
...
func (plonkcs *CS) checkConstraint(c backend.SparseR1C, solution []fr.Element) error {
