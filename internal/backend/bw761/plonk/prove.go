...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bw761.Poly, bw761.Poly, bw761.Poly, bw761.Poly) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bw761.Poly
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bw761witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bw761.Poly{l, r, o, z, h1, h2, h3}
