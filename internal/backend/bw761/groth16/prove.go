...
func computeH(a, b, c []fr.Element, fftDomain *bw761backend.Domain) []fr.Element {
	...
	go func() {
		...
		bw761backend.BitReverse(expTable)
		m.Unlock()
	}()
	...
	FFTa := func(s []fr.Element) {
		// FFT inverse
		bw761backend.FFT(s, fftDomain.GeneratorInv, bw761backend.DIF)
		...
		// FFT coset
		bw761backend.FFT(s, fftDomain.Generator, bw761backend.DIT)
		wg.Done()
	}
	wg.Add(3)
	go FFTa(a)
	...
	// ifft_coset
	bw761backend.FFT(a, fftDomain.GeneratorInv, bw761backend.DIF)
