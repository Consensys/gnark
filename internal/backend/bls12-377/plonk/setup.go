...
type ProvingKey struct {
	...
	Ql, Qr, Qm, Qo bls12377.Polynomial
...
func Compute(pk *ProvingKey) {
	...
	pk.LS1 = make(bls12377.Polynomial, nbElmt)
	pk.LS2 = make(bls12377.Polynomial, nbElmt)
	pk.LS3 = make(bls12377.Polynomial, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	pk.CS1 = make(bls12377.Polynomial, nbElmt)
	pk.CS2 = make(bls12377.Polynomial, nbElmt)
	pk.CS3 = make(bls12377.Polynomial, nbElmt)
	copy(pk.CS1, pk.LS1)
	copy(pk.CS2, pk.LS2)
	copy(pk.CS3, pk.LS3)
