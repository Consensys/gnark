...
func ComputeLROBis(spr *cs.SparseR1CS, pk *ProvingKey, solution []fr.Element) (bls12377.Polynomial, bls12377.Polynomial, bls12377.Polynomial) {

	s := int(pk.DomainNum.Cardinality)

	var l, r, o bls12377.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZBis(l, r, o bls12377.Polynomial, pk *ProvingKey, gamma fr.Element) bls12377.Polynomial {

	z := make(bls12377.Polynomial, pk.DomainNum.Cardinality)
...
func evalIDCosetsBis(pk *ProvingKey) (id, uid, uuid bls12377.Polynomial) {
...
func evalConstraintOrderingBis(pk *ProvingKey, evalZ, evalZu, evalL, evalR, evalO bls12377.Polynomial, gamma fr.Element) bls12377.Polynomial {
	...
	res := make(bls12377.Polynomial, 4*pk.DomainNum.Cardinality)
...
func evalStartsAtOneBis(pk *ProvingKey, evalZ bls12377.Polynomial) bls12377.Polynomial {
...
func shitZBis(z bls12377.Polynomial) bls12377.Polynomial {
...
func computeHBis(pk *ProvingKey, constraintsInd, constraintOrdering, startsAtOne bls12377.Polynomial, alpha fr.Element) (bls12377.Polynomial, bls12377.Polynomial, bls12377.Polynomial) {

	h := make(bls12377.Polynomial, pk.DomainH.Cardinality)
	...
	h1 := make(bls12377.Polynomial, pk.DomainNum.Cardinality)
	h2 := make(bls12377.Polynomial, pk.DomainNum.Cardinality)
	h3 := make(bls12377.Polynomial, pk.DomainNum.Cardinality)
...
func computeLinearizedPolynomial(l, r, o, alpha, gamma, zeta, zu fr.Element, z bls12377.Polynomial, pk *ProvingKey) bls12377.Polynomial {
	...
	linearizedPolynomial := _linearizedPolynomial.(*bls12377.Polynomial)
...
func Prove(spr *cs.SparseR1CS, pk *ProvingKey, fullWitness bls12_377witness.Witness) (*Proof, error) {
	...
	cl := make(bls12377.Polynomial, sizeCommon)
	cr := make(bls12377.Polynomial, sizeCommon)
	co := make(bls12377.Polynomial, sizeCommon)
	copy(cl, ll)
	copy(cr, lr)
	copy(co, lo)
	...
	qkFullC := make(bls12377.Polynomial, sizeCommon)
