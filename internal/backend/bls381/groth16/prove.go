...
func computeH(a, b, c []fr.Element, fftDomain *bls381backend.Domain) []fr.Element {
	...
	go func() {
		...
		bls381backend.BitReverse(expTable)
		m.Unlock()
	}()
	...
	FFTa := func(s []fr.Element) {
		// FFT inverse
		bls381backend.FFT(s, fftDomain.GeneratorInv, bls381backend.DIF)
		...
		// FFT coset
		bls381backend.FFT(s, fftDomain.Generator, bls381backend.DIT)
		wg.Done()
	}
	wg.Add(3)
	go FFTa(a)
	...
	// ifft_coset
	bls381backend.FFT(a, fftDomain.GeneratorInv, bls381backend.DIF)
