...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bls381.Poly) (bls381.Poly, bls381.Poly, bls381.Poly) {

	h := make(bls381.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bls381.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bls381.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bls381.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bls381witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bls381.Poly{l, r, o, z, h1, h2, h3}
