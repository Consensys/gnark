...
type PublicRaw struct {
	...
	LS1, LS2, LS3 bls381.Poly
	CS1, CS2, CS3 bls381.Poly
...
func SetupRaw(spr *cs.SparseR1CS, polynomialCommitment polynomial.CommitmentScheme, publicWitness bls381witness.Witness) *PublicRaw {
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bls381.Poly, nbElmt)
	publicData.LS2 = make(bls381.Poly, nbElmt)
	publicData.LS3 = make(bls381.Poly, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bls381.Poly, nbElmt)
	publicData.CS2 = make(bls381.Poly, nbElmt)
	publicData.CS3 = make(bls381.Poly, nbElmt)
