...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bw6761.Polynomial, bw6761.Polynomial, bw6761.Polynomial, bw6761.Polynomial) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bw6761.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bw6761.Polynomial) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bw6761.Polynomial, gamma fr.Element) bw6761.Polynomial {
	...
	res := make(bw6761.Polynomial, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bw6761.Polynomial) bw6761.Polynomial {
...
func shiftZ(z bw6761.Polynomial) bw6761.Polynomial {
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bw6761.Polynomial, alpha fr.Element) (bw6761.Polynomial, bw6761.Polynomial, bw6761.Polynomial) {
	...
	h1 := make(bw6761.Polynomial, publicData.DomainNum.Cardinality)
	h2 := make(bw6761.Polynomial, publicData.DomainNum.Cardinality)
	h3 := make(bw6761.Polynomial, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bw6_761witness.Witness) (*ProofRaw, error) {
