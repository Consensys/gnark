...
func ComputeLROBis(spr *cs.SparseR1CS, pk *ProvingKey, solution []fr.Element) (bw6761.Polynomial, bw6761.Polynomial, bw6761.Polynomial) {

	s := int(pk.DomainNum.Cardinality)

	var l, r, o bw6761.Polynomial
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZBis(l, r, o bw6761.Polynomial, pk *ProvingKey, gamma fr.Element) bw6761.Polynomial {

	z := make(bw6761.Polynomial, pk.DomainNum.Cardinality)
...
func evalIDCosetsBis(pk *ProvingKey) (id, uid, uuid bw6761.Polynomial) {
...
func evalConstraintOrderingBis(pk *ProvingKey, evalZ, evalZu, evalL, evalR, evalO bw6761.Polynomial, gamma fr.Element) bw6761.Polynomial {
	...
	res := make(bw6761.Polynomial, 4*pk.DomainNum.Cardinality)
...
func evalStartsAtOneBis(pk *ProvingKey, evalZ bw6761.Polynomial) bw6761.Polynomial {
...
func shitZBis(z bw6761.Polynomial) bw6761.Polynomial {

	res := make(bw6761.Polynomial, len(z))
	copy(res, z)
...
func computeHBis(pk *ProvingKey, constraintsInd, constraintOrdering, startsAtOne bw6761.Polynomial, alpha fr.Element) (bw6761.Polynomial, bw6761.Polynomial, bw6761.Polynomial) {

	h := make(bw6761.Polynomial, pk.DomainH.Cardinality)
	...
	h1 := make(bw6761.Polynomial, pk.DomainNum.Cardinality)
	h2 := make(bw6761.Polynomial, pk.DomainNum.Cardinality)
	h3 := make(bw6761.Polynomial, pk.DomainNum.Cardinality)
...
func computeLinearizedPolynomial(l, r, o, alpha, gamma, zeta, zu fr.Element, z bw6761.Polynomial, pk *ProvingKey) bw6761.Polynomial {
	...
	linearizedPolynomial := _linearizedPolynomial.(*bw6761.Polynomial)
...
func Prove(spr *cs.SparseR1CS, pk *ProvingKey, fullWitness bw6_761witness.Witness) (*Proof, error) {
	...
	cl := make(bw6761.Polynomial, sizeCommon)
	cr := make(bw6761.Polynomial, sizeCommon)
	co := make(bw6761.Polynomial, sizeCommon)
	copy(cl, ll)
	copy(cr, lr)
	copy(co, lo)
	...
	qkFullC := make(bw6761.Polynomial, sizeCommon)
