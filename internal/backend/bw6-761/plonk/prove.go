...
import (
	...
	"github.com/consensys/gnark/crypto/polynomial/bw6-761"
...
func ComputeLRO(spr *cs.SparseR1CS, publicData *PublicRaw, solution []fr.Element) (bw6761.Poly, bw6761.Poly, bw6761.Poly, bw6761.Poly) {

	s := int(publicData.DomainNum.Cardinality)

	var l, r, o, partialL bw6761.Poly
	l = make([]fr.Element, s)
	r = make([]fr.Element, s)
	o = make([]fr.Element, s)
...
func ComputeZ(l, r, o bw6761.Poly, publicData *PublicRaw) bw6761.Poly {

	z := make(bw6761.Poly, publicData.DomainNum.Cardinality)
...
func evalIDCosets(publicData *PublicRaw) (id, uid, uuid bw6761.Poly) {
...
func evalConstraintOrdering(publicData *PublicRaw, evalZ, evalZu, evalL, evalR, evalO bw6761.Poly) bw6761.Poly {
	...
	res := make(bw6761.Poly, 4*publicData.DomainNum.Cardinality)
...
func evalStartsAtOne(publicData *PublicRaw, evalZ bw6761.Poly) bw6761.Poly {
...
func shiftZ(z bw6761.Poly) bw6761.Poly {

	res := make(bw6761.Poly, len(z))
	copy(res, z)
...
func computeH(publicData *PublicRaw, constraintsInd, constraintOrdering, startsAtOne bw6761.Poly) (bw6761.Poly, bw6761.Poly, bw6761.Poly) {

	h := make(bw6761.Poly, publicData.DomainH.Cardinality)
	...
	h1 := make(bw6761.Poly, publicData.DomainNum.Cardinality)
	h2 := make(bw6761.Poly, publicData.DomainNum.Cardinality)
	h3 := make(bw6761.Poly, publicData.DomainNum.Cardinality)
...
func ProveRaw(spr *cs.SparseR1CS, publicData *PublicRaw, fullWitness bw6_761witness.Witness) *ProofRaw {
	...
	polynomialsToOpenAtZeta := []bw6761.Poly{l, r, o, z, h1, h2, h3}
