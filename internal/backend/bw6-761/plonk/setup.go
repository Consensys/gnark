...
type PublicRaw struct {
	...
	Ql, Qr, Qm, Qo, Qk bw6761.Polynomial
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bw6761.Polynomial, nbElmt)
	publicData.LS2 = make(bw6761.Polynomial, nbElmt)
	publicData.LS3 = make(bw6761.Polynomial, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bw6761.Polynomial, nbElmt)
	publicData.CS2 = make(bw6761.Polynomial, nbElmt)
	publicData.CS3 = make(bw6761.Polynomial, nbElmt)
