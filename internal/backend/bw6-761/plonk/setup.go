...
type PublicRaw struct {
	...
	LS1, LS2, LS3 bw6761.Poly
	CS1, CS2, CS3 bw6761.Poly
...
func SetupRaw(spr *cs.SparseR1CS, polynomialCommitment polynomial.CommitmentScheme, publicWitness bw6_761witness.Witness) *PublicRaw {
...
func ComputeS(publicData *PublicRaw) {
	...
	publicData.LS1 = make(bw6761.Poly, nbElmt)
	publicData.LS2 = make(bw6761.Poly, nbElmt)
	publicData.LS3 = make(bw6761.Poly, nbElmt)
	for i := 0; i < nbElmt; i++ {
	...
	publicData.CS1 = make(bw6761.Poly, nbElmt)
	publicData.CS2 = make(bw6761.Poly, nbElmt)
	publicData.CS3 = make(bw6761.Poly, nbElmt)
