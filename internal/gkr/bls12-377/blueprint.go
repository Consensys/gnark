...
func init() {
	...
	constraint.RegisterBlueprintType(constraint.GkrTagBase+uint64(ecc.BLS12_377)*3+0, reflect.TypeOf(BlueprintSolve{}))
	constraint.RegisterBlueprintType(constraint.GkrTagBase+uint64(ecc.BLS12_377)*3+1, reflect.TypeOf(BlueprintProve{}))
	constraint.RegisterBlueprintType(constraint.GkrTagBase+uint64(ecc.BLS12_377)*3+2, reflect.TypeOf(BlueprintGetAssignment{}))
}
...
// BlueprintProve is a BLS12_377-specific blueprint for generating GKR proofs.
...
func (b *BlueprintProve) Solve(s constraint.Solver[constraint.U64], inst constraint.Instruction) error {
	...
	hsh := hash.NewHash(b.HashName + "_BLS12_377")
...
// BlueprintGetAssignment is a BLS12_377-specific blueprint for retrieving wire assignments.
