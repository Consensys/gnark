...
func (e *zeroCheckLazyClaims) roundCombinationCoeff(round int) (fr.Element, bool) {
...
func (c *zeroCheckClaims) roundPolynomialSingleSource() polynomial.Polynomial {
	...
	computeAll := func(start, end int) {
		...
		res := make([]fr.Element, degree)
		inputEvals := make([]fr.Element, (degree+1)*nbUniqueInputs)
		weights := make([]fr.Element, nbWires)
