...
// BlueprintSolve is a BLS24_317-specific blueprint for solving GKR circuit instances.
...
// BlueprintProve is a BLS24_317-specific blueprint for generating GKR proofs.
...
func (b *BlueprintProve) Solve(s constraint.Solver[constraint.U64], inst constraint.Instruction) error {
	...
	hsh := hash.NewHash(b.HashName + "_BLS24_317")
	fsSettings := fiatshamir.WithHash(hsh, insBytes...)

	// Call the BLS24_317-specific Prove function (assignments already WireAssignment type)
...
// BlueprintGetAssignment is a BLS24_317-specific blueprint for retrieving wire assignments.
...
// NewBlueprints creates and registers all GKR blueprints for BLS24_317
